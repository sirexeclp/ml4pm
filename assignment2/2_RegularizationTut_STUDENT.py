...
# %% [markdown] {"colab_type": "text", "id": "2mcbz7SWBq_I"}
...
# %% [markdown] {"colab_type": "text", "id": "0aMzuc9yBq_e"}
# ***

# %% [markdown] {"colab_type": "text", "id": "WFgMzECvBq_g"}
...
# %% [markdown] {"colab_type": "text", "id": "HiqqnzAIBq_h"}
...
# %% [markdown] {"colab_type": "text", "id": "GA4KAMruBq_k"}
...
# %% [markdown] {"colab_type": "text", "id": "NaF2nN5bBq_r"}
...
# %% [markdown] {"colab_type": "text", "id": "PAHriYbBBq_y"}
# **Question 1**:  
...
# %% [markdown] {"colab_type": "raw", "id": "R0w6_UR7Bq_z"}
# x-axis: Independant Variable (Glucose or Age or Pedigree Function)  
#
# y-axis: Frequency

# %% [markdown] {"colab_type": "text", "id": "sjDfotQiBq_0"}
...
# %% [markdown] {"colab_type": "text", "id": "ikz-7g1zBq_6"}
# ## Task 2:
#
...
# %% [markdown] {"colab_type": "text", "id": "QhWZL2aZBrAI"}
...
# %% [markdown] {"colab_type": "text", "id": "Epd4D7JBBrAN"}
...
# %% [markdown] {"colab_type": "text", "id": "wnrp1R8oBrAO"}
# ## Task 3:
...
# %% [markdown] {"colab_type": "text", "id": "LVTubdPcBrAY"}
#
...
# %% [markdown] {"colab_type": "text", "id": "-FOg41cYBrAe"}
...
# %% [markdown] {"colab_type": "raw", "id": "00nQsbZZBrAg"}
# - train: $70\%$
# - validation: $15\%$
# - test: $15\%$

# %% [markdown] {"colab_type": "text", "id": "KvzVH24UBrAg"}
# ## Task 4:  
...
# %% [markdown] {"colab_type": "text", "id": "3vzraEi1BrAq"}
# **Expected Output:**  
# bias: -0.029  
# Pregnancies: -0.187  
# Glucose: 0.544  
...
# %% [markdown] {"colab_type": "text", "id": "IbApl6ouBrAs"}
...
# %% [markdown] {"colab_type": "text", "id": "MTxJm24YBrA3"}
# **Question 3**:  
...
# %% [markdown] {"colab_type": "raw", "id": "GuLLRFrXBrA5"}
...
# %% [markdown] {"colab_type": "text", "id": "kafg6gLXBrA6"}
# ***
...
# %% [markdown] {"colab_type": "raw", "id": "nqii2jG1BrA7"}
...
# %% [markdown] {"colab_type": "text", "id": "KDuij6VlBrA-"}
...
# %% [markdown] {"colab_type": "text", "id": "2MLMWn7-BrBD"}
# ## Task 6:  
#
...
# %% [markdown] {"colab_type": "text", "id": "bK_5FyzOBrBI"}
# ## Task 7:    
...
# %% [markdown] {"colab_type": "text", "id": "d57G52x3BrBO"}
# **Expected Output**:  
# mse: [0.9696, 0.9539, ... , 0.8038, 0.8039]

# %% [markdown] {"colab_type": "text", "id": "UF6bPs_fBrBO"}
...
# %% [markdown] {"colab_type": "text", "id": "fVYFgEVkBrBT"}
# ## Task 8:
#
...
# %% [markdown] {"colab_type": "text", "id": "it6Q7Ef-BrBm"}
# ** Expected Output: **
#
# best lambda: 0.237
#
...
# %% [markdown] {"colab_type": "text", "id": "8GUmmDIwBrBp"}
...
# %% [markdown] {"colab_type": "text", "id": "pxQXCnP4BrBt"}
# ** Expected Output **:  
#
# Least Squares MSE: 0.5832  
# L2-regularized Least Squares MSE: 0.5651

# %% [markdown] {"colab_type": "text", "id": "0X6H4kJcBrBu"}
# ## Discussion
#
...
# %% [markdown] {"colab_type": "text", "id": "mLegAb8gBrBv"}
# ## Note:
#
...
# %% [markdown] {"colab_type": "text", "id": "C-VDLZWoBrBw"}
